...
VALUES ('Аркадий', '+7777777', 'arkm@html.com', 'нащельник 3 штуки',
       ...
       ('Тест', '+050050', 'manager@vagonka.kharkov.ua',
        'просто проверяю отправку контрактов', '2020-05-14 22:46:27', 'CANCELLED')
        ,
       ('Аня', '+09090', '', 'хочу заказать плинтус', '2020-05-15 10:33:16', 'PROCESSED')
        ,
       ...
       ('Антон', '099999999', 'antzant@xmail.com',
        'хочу оформить заказ. можете перезвонить?', '2020-05-17 19:03:16', 'NEW')
        ,
